...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Multi-Location Coordination Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Coordinated Entity";
process.env.TABLE_NAME = process.env.TABLE_NAME || "coordinated_entity_records";
'use strict';
